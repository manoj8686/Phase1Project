...
public class Serial_DeSerial {
	...
	{
		employee obj = new employee(101, 25, "harish", "ece", 8296, "harish@gmail.com");
		employee obj2 = new employee(102, 26, "manoj", "ece", 829696, "manoj@gmail.com");
	    
	    FileOutputStream fos= null;
	    ObjectOutputStream oos=  null;
	    
	    try{ 
	      fos = new FileOutputStream("E:\\MANOJ JAVA\\assignments"); 
	    ...
	    employee o2=null;
	     try{
	       FileInputStream fis = new FileInputStream("E:\\MANOJ JAVA\\assignments");
