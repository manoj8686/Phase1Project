		...
		public class Student {
			 String name;
			    ...
			    public static void main(String[] args) {
			        Student s1 = new Student("manoj", 23, 'A','M', 77,79,89);
			        Student s2 = new Student("dileep", 25, 'B','M', 0,56,65);
			        Student s3 = new Student("harish", 26, 'A','M', 0,89,66);
			        Student s4 = new Student("sarath", 23, 'B','M', 79,98,87);
